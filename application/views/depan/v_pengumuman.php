...
<body>
    <!--============================= HEADER =============================-->
    <div class="header-topbar" style="background-color: cornflowerblue;">
        <div class="container">
            <div class="row">
...
<section class="events">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2 class="event-title">Dunia Usaha & Dunia Industri</h2>
            </div>
        </div>
        <br>
        <div class="row">
                ...
                <div class="tab-pane active" id="upcoming-events" role="tabpanel">
                  <?php foreach($data->result() as $row):?>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-3"> 
                                 <img src="<?php echo base_url().'assets/images/'.$row->pengumuman_gambar;?>" class="all img-fluid" alt="#" style="width: 200px;">
                            </div>
                                <!-- add gambar dari database
                                <img src="< ? php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" class="img-fluid" alt="courses-img" style="border-radius: 35px 35px 0px 0px;">
                                --->
                                <!-- // end .col-sm-3 -->
                            <div class="col-md-10">
                                <div class="event-heading">
                                    ...
                                    <span class="icon-location-pin"></span> <?php echo $row->pengumuman_tempat;?>
                                </div>
                          </div>
                      </div>
...
<!--//END EVENTS -->
<!--============================= FOOTER =============================-->
<footer class="foot" style="background-color: cornflowerblue;">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
