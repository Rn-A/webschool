                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('about');?>">ABOUT</a>
                                      <li class="nav-item">
                                  <a class="nav-link" href="<?php echo site_url('kurikulum');?>">KURIKULUM</a>
                                </li>
                                </li>
                                <li class="nav-item">
...
<section class="welcome_about">
    ...
    <section class="testimonial">
        <div class="container" style="background: #bbeeff; border-radius:10px;">
            <div class="row">
                <div class="col-md-12">
                    <h2>Testimonial</h2>
                </div>
                    ...
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <div class="testi-img_block">
                                ...
                                <p><span><b>Hernandez Alvaro</b></span>Siswa Terbaik 2018</p>
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="chart-text">
                        <p><span class="counter"><?php echo $tot_agenda;?></span> Prestasi</p>
                    </div>
                </div>
            </div>
        </div>
