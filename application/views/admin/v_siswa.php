...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/siswa'?>"><i class="fa fa-star-o"></i> Prestasi Siswa</a></li>
  ...
  <div class="content-wrapper">
    ...
    #7fc9d9 100%
        ...
        <li class="active" style="color: #000;">Siswa</li>
      </ol>
    </section>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Juara</label>
                                        <div class="col-sm-7">
                                          <select name="xkelas" class="form-control" required>
                                            <option value="">-Pilih-</option>
                                            <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xmapel" value="" class="form-control" id="inputUserName" placeholder="Nama Prestasi" required>
                                        </div>
                                    </div>
