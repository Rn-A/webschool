...
<div class="wrapper">
  ...
  <aside class="main-sidebar" style=" background: linear-gradient(to bottom right, #6889ff, #c668ff);">
  ...
  <div class="content-wrapper">
    ...
    #7fc9d9 100%
        ...
        <li class="active" style="color: #000;">DUDI</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add DUDI</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add DUDI</h4>
                    </div>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Nama DUDI</label>
                                <div class="col-sm-7">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit DUDI</h4>
                    </div>
...
<?php if($this->session->flashdata('msg')=='error'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Error',
                    text: "Ada kesalahan saat menambah pengumuman",
