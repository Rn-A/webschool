...
<header class="main-header">  
    ...
    <!-- Logo -->
    <a href="<?php echo base_url().'admin/dashboard'?>" class="logo" style="background: linear-gradient(
    to bottom right,
    #dd95f7 0%,
    #9aadf9 50%,
    #7fc9d9 100%
      ...
      <span class="logo-mini"><img class="img img-responsive" width="190px;" style="padding: 5px;" src="<?php echo base_url().'theme/images/rpl2.png'?>"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img class="img img-responsive" width="190px;" style="padding: 5px;" src="<?php echo base_url().'theme/images/rpl.png'?>"></span>
    </a>

    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="background: linear-gradient(to bottom right, #6889ff, #c668ff);">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header" style="background: #6889ff;">
