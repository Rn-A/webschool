...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    #7fc9d9 100%
        ...
        <li class="active" style="color: #000;">Prestasi</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:12px;">
				...
				<?php
                    ...
                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/images/'.$agenda_gambar;?>" style="width:80px;"></td>
