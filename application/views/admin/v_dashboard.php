...
<head>
  ...
  <link rel="stylesheet" href="theme/css/admin-revisi.css">
  <?php
...
<div class="wrapper">
  ...
  <aside class="main-sidebar" style="background: linear-gradient(to bottom right, #6889ff, #c668ff); color:#fff">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header" style="background:#1e282c; color:#fff;">Menu Utama</li>
        <li class="active">
        ...
        <li>
          ...
          <i class="fa fa-trophy"></i> <span>Prestasi Siswa</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
        ...
        <li>
          <a href="<?php echo base_url().'admin/pengumuman'?>">
            <i class="fa fa-industry"></i> <span>DUDI</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb" style="background: linear-gradient(
    to bottom right,
    #dd95f7 0%,
    #9aadf9 50%,
    #7fc9d9 100%
        ...
        <li class="active" style="color: #000;">Dashboard</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-aqua" style=" background: linear-gradient(to bottom right, #6889ff, #c668ff);"><i class="fa fa-chrome"></i></span>
              <?php
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-red" style=" background: linear-gradient(
    to bottom right,
    #dd95f7 0%,
    #9aadf9 50%,
    #7fc9d9 100%
  );"><i class="fa fa-firefox"></i></span>
            <?php
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-green" style=" background: linear-gradient(
    to bottom right,
    #dd95f7 0%,
    #9aadf9 50%,
    #7fc9d9 100%
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-yellow" style=" background: linear-gradient(to bottom right, #6889ff, #c668ff);"><i class="fa fa-opera"></i></span>
            <?php
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <!-- Info Boxes Style 2 -->
          <div class="info-box bg-yellow" style="border-radius: 0px 0px 20px 0px;  background: linear-gradient(to bottom right, #6889ff, #c668ff);">
          ...
          <!-- /.info-box -->
          <div class="info-box bg-green" style="border-radius: 0px 0px 20px 0px; background: linear-gradient(
    to bottom right,
    #dd95f7 0%,
    #9aadf9 50%,
    #7fc9d9 100%
          ...
          <!-- /.info-box -->
          <div class="info-box bg-red" style="border-radius: 0px 0px 20px 0px;  background: linear-gradient(to bottom right, #6889ff, #c668ff);">
          ...
          <!-- /.info-box -->
          <div class="info-box bg-aqua" style="border-radius: 0px 0px 20px 0px;  background: linear-gradient(
    to bottom right,
    #dd95f7 0%,
    #9aadf9 50%,
    #7fc9d9 100%
  ...
  <footer class="main-footer">
    ...
    <strong><b><i>Rekayasa Perangkat Lunak</i></b>|<img src="<?php echo base_url().'theme/images/rpl2.png'?>" style="width: 20px; height:20px">
  </footer>
